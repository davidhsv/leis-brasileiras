...
from leis_brasileiras.leis import (
    ...
    ProjetosDeLeiComplementarCamaraMunicipalRJ0912, Planalto, DecretosPlanalto, LeisOrdinariasPlanalto
...
docs = [
    ...
    LeisOrdinariasPlanalto(
        f'{OUTPUT_FOLDER}/decretos_planalto.csv'),
]
